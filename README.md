...
| **STOCKer**        | Built a pipeline to analyze stock price fluctuations, cluster related news articles using embeddings, and extract keywords with AI. | Spring Boot, JPA, Python, OpenAI API, AWS (EC2, Route 53, ELB) |
